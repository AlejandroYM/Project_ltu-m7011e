...
function App() {
  ...
  const fetchData = async (userId) => {
    try {
      ...
      // ✅ Fix: usar siempre recipesData que garantiza un array
      const recipesData = Array.isArray(resRecipes.data)
        ? resRecipes.data
        : resRecipes.data.recipes || [];
      setRecipes(recipesData);
      applyFilters(recipesData, searchTerm, filterCategory, filterTime);
  ...
  return (
    <div className="app-container">
      ...
      <main style={{ padding: '2rem 3rem', maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
        ...
        {/* ✅ MONTHLY MEAL PLANNER — reemplaza el weekly plan */}
        <MonthlyMealPlan 
          keycloak={keycloak} 
